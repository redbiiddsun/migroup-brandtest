export const highInvolvementProductsTH = {
    locale: 'th',
    type: "high",
        ...
        elements: [
          {
            ...
            title: "ท่านคิดว่าผู้บริโภคหรือลูกค้ามีความเชื่อถือต่อแบรนด์ของท่านอยู่ในระดับใด",
          ...
          },
          {
            ...
            title: "ท่านคิดว่าผู้บริโภคหรือลูกค้ามองว่าแบรนด์ของท่านเป็นแบรนด์นวัตกรรมมีความแปลกใหม่อยู่เสมอหรือไม่",
          ...
          },
          {
            ...
            title: "ท่านคิดว่าแบรนด์ของท่านมีชื่อเสียงหรือเป็นที่ยอมรับในตลาดมากน้อยเพียงใด",
            description: "1 = น้อยมาก/ ไม่มีใครรู้จักแบรนด์ 5 = มากที่สุด/ แบรนด์เป็นที่รู้จักของทุกคน",
            autoGenerate: true,
            rateCount: 5,
            isRequired: true,
            rateValues: [ 1, 2, 3, 4, 5 ]
        ...
        elements: [
          {
            type: "rating",
            name: "BrandValue-1",
            title: "ผู้บริโภคหรือลูกค้าประเมินคุณภาพของสินค้า/ บริการของแบรนด์อยู่ในระดับใด",
          ...
          },
          {
            type: "rating",
            name: "BrandValue-2",
            title: "ผู้บริโภคหรือลูกค้าประเมินว่าผลิตภัณฑ์ของแบรนด์ท่านมีความคุ้มค่าต่อเงินที่จ่ายไป",
          ...
          },
          {
            type: "rating",
            name: "BrandValue-3",
            title: "แบรนด์ของท่านมีความเป็นมิตรกับสิ่งแวดล้อมและมีความรับผิดชอบต่อสังคมมากน้อยเพียงใด",
      ...
      },
      {
        ...
        elements: [
          ...
          },
          {
            ...
            title: "แบรนด์ของท่านได้มีการนำเสนอผลิตภัณฑ์อย่างเข้าใจผู้บริโภคหรือกำหนดเทรนด์ในอุตสาหกรรมอย่างต่อเนื่องหรือไม่",
          ...
          },
          {
            ...
            title: "ผู้บริโภคหรือลูกค้ามีความรู้สึกผูกพันกับแบรนด์ของท่านมากน้อยเพียงใด",
      ...
      },
      {
        ...
        elements: [
          ...
          },
          {
            ...
            title: "ท่านคิดว่าลูกค้าของท่านจะพิจารณาซื้อผลิตภัณฑ์ของแบรนด์ท่านในระยะยาวหรือไม่",
        ...
        elements: [
          {
            ...
            title: "ผลิตภัณฑ์ของแบรนด์ท่านมีคุณสมบัติที่เป็นเลิศและเป็นประโยชน์หรือไม่",
          ...
          },
          {
            ...
            title: "เมื่อเทียบกับคู่แข่ง ผลิตภัณฑ์ของท่านนั้นมีความโดดเด่นและแปลกใหม่หรือไม่",
            description: "1 = ไม่โดดเด่นและไม่แปลกใหม่เเลย; 5 = โดดเด่นและแปลกใหม่ที่สุด",
            autoGenerate: true,
            rateCount: 5,
            isRequired: true,
            rateValues: [ 1, 2, 3, 4, 5 ]
